        ...
        <div className="hero bg-zinc-800/50 p-7 rounded-2xl md:p-12">
          <div className="hero-content flex flex-col">
            ...
            <p className="text-zinc-300 md:text-center mb-4 md:mb-6 md:text-lg md:max-w-[60ch] lg:text-start">
              ...
              particularly on the front end, where I enjoy seeing the visual
              impact of my code. I have experience working with technologies
              like React, Node.js, TailwindCSS and Material UI, and I’m
            ...
            <p className="text-zinc-300 md:text-center mb-1 md:mb-1 md:text-lg md:max-w-[60ch] lg:text-start">
              ...
              work on, always with the goal of creating meaningful digital
              experiences.
            </p>
          </div>
        </div>
